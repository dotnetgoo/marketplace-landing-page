          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button 
                ...
                className="relative p-2 hover:bg-slate-800 rounded-full transition-colors duration-200"
                aria-label="Search"
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl animate-slide-up">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold text-slate-900">Search Products</h3>
                <button
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    className="w-full px-6 py-4 pr-12 border-2 border-slate-200 rounded-xl text-lg focus:border-orange-500 focus:outline-none transition-colors duration-200"
                    autoFocus
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white p-3 rounded-lg transition-colors duration-200"
                    aria-label="Search"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Headphones', 'Smart Watch', 'Laptop', 'Keyboard', 'Mouse', 'Speaker'].map((term) => (
                    <button
                      key={term}
                      onClick={() => {
                        setSearchQuery(term)
                      ...
                      className="px-4 py-2 bg-slate-100 hover:bg-orange-100 hover:text-orange-600 text-slate-700 rounded-full text-sm font-medium transition-colors duration-200"
                    >
                      {term}
                    </button>
                  ))}
